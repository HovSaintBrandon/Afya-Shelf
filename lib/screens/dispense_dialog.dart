...
class _DispenseDialogState extends State<DispenseDialog> {
  ...
  void _showSuccessScreen(String dispenseId) async {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (context) => _ReceiptDialog(dispenseId: dispenseId),
    ).then((_) {
...
class _ReceiptDialog extends StatefulWidget {
  ...
  const _ReceiptDialog({required this.dispenseId});
  ...
  Widget build(BuildContext context) {
    ...
    if (_error != null || _receipt == null) {
      return AlertDialog(
        ...
        content: const Text('The medication has been dispensed, but we couldn\'t load the receipt details at this moment.'),
        actions: [
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(_receipt!['receiptNumber'], style: GoogleFonts.inter(fontSize: 14, color: AfyaTheme.textSecondary, fontWeight: FontWeight.w600)),
                const SizedBox(height: 24),
                const _DashedLine(),
                Padding(
                  ...
                  child: Column(
                    children: [
                      _receiptRow('Clinic', _receipt!['clinic']['name']),
                      _receiptRow('Location', _receipt!['clinic']['location']),
                      _receiptRow('Date', _receipt!['date'].toString().split('T')[0]),
                      _receiptRow('Dispensed By', _receipt!['issuedBy']),
                      const Padding(
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(item['description'], style: GoogleFonts.inter(fontWeight: FontWeight.w700, color: AfyaTheme.textPrimary)),
